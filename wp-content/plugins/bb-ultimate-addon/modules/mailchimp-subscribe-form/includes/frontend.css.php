	...
	.fl-node-<?php echo $id; ?> .uabb-sf-style-style2 .uabb-form-field.open > label {
		...
		if ( isset( $settings->input_font_typo['font_size']['length'] ) && '' != $settings->input_font_typo['font_size']['length'] ) :
			...
			if ( is_numeric( $settings->input_font_typo['font_size']['length'] ) ) {
				...
				-webkit-transform: translateY(-<?php echo $settings->input_font_typo['font_size']['length'] + 10; ?>px);
				-ms-transform: translateY(-<?php echo $settings->input_font_typo['font_size']['length'] + 10; ?>px);
				transform: translateY(-<?php echo $settings->input_font_typo['font_size']['length'] + 10; ?>px);
				<?php
			}
		endif;
		?>
